...
enum parameters {ELEMENT_LENGTH,PSI,ALFA,GAMMA,OMICRON,LAMBDA,NI,KAPPA,TAO};
...
class mesh{
    ...
    public:
        void setParameters(float l,float t,float k,
		float la,float v,float psi,float a,float g,float n){
            parameters[ELEMENT_LENGTH]=l;
            parameters[TAO]=t;
            parameters[KAPPA]=k;
            parameters[LAMBDA]=la;
            parameters[OMICRON]=v;
            parameters[PSI]=psi;
            parameters[ALFA]=a;
            parameters[GAMMA]=g;
            parameters[NI]=n;
